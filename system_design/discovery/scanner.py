...
from system_design.discovery.doc_detector import detect_documentation
from system_design.discovery.framework_detector import detect_frameworks
from system_design.discovery.language_detector import detect_languages, primary_language
from system_design.discovery.models import (
    InfrastructureDetection,
    InfrastructureType,
    RepositoryInventory,
)
from system_design.discovery.package_detector import detect_package_managers
